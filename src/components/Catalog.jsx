	...
	return (
		<main className="flex mx-6 my-8">
			...
			<section className="w-full mt-4">
				...
				<button
					type="reset"
					className="uppercase font-extrabold text-green-700 mb-8"
				>
					Clear Filters
				</button>
				<div className="flex flex-wrap gap-5">
					{data.map(({ id, title, img, price, msrp }) => {
						if (isValidating) {
							return (
								<article
									className="relative flex flex-col items-start w-[150px] mb-6"
									key={id}
								>
									...
									<div className="text-lg w-20 bg-gray-200 animate-pulse rounded">
										&nbsp;
									</div>
								</article>
							)
